...
if ('share' in navigator) {
  ...
  nativeShareButton.innerHTML = `<svg width="22" height="22" viewBox="0 0 16 16" class="bi bi-box-arrow-up" fill="var(--primary)" xmlns="http://www.w3.org/2000/svg">
  ...
  shareSectionElement.insertBefore(nativeShareButton, copyLinkButton)
}
